...
import {workshopsData} from '../../constant/index.js'
...
const Workshops = () => {
  ...
  return (
    <>
      <Branch title={"الفعاليات وورش العمل"}/>
      <section className="overflow-hidden py-5 d-flex align-items-center">
        <div className="container">
          ...
          >
            اطلع على احدث الفعاليات وورش العمل التي تقدم نصائح<br /> وأفكار مبتكرة لتطوير حياتك ومهاراتك
          </p>
            ...
            {currentWorkshops.map((workshop, index) => (
              ...
              >
                <div className="card h-100 custom-card overflow-hidden p-4 shadow-lg rounded-3">
                  <img src={workshopImg} className="card-img-top" alt="workshop-img" />
                  ...
                  <div className="card-body d-flex justify-content-start align-items-center">
                    <a href="#" className="btn course-info rounded-pill text-white">
                      ...
                      <span className="p-2 fs-5 fw-bold text-black">تفاصيل </span>
                    </a>
                  </div>
                </div>
              </motion.div>
